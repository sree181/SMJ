#!/usr/bin/env python3
"""
Production-Grade Batch Processor for SMJ Papers (1985-1994)
Processes all papers in 5-year temporal windows with comprehensive entity extraction
"""
...
from Kb import LiteratureAgent, PaperMetadata, ResearchQuestion, Methodology, Finding, Contribution, ResearchEntity, Relationship
...
class BatchProcessor:
    """Production-grade batch processor for SMJ papers"""
    
    def __init__(self, base_dir: Path, neo4j_uri: str = None, neo4j_user: str = None, neo4j_password: str = None, openai_api_key: str = None):
    ...
    def process_single_paper(self, pdf_path: Path, window_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Process the paper
            result = self.agent.process_single_paper(pdf_path)
    ...
    def process_temporal_window(self, start_year: int, end_year: int, max_workers: int = 3) -> Dict[str, Any]:
    ...
    def process_all_windows(self, start_year: int, end_year: int, max_workers: int = 3) -> Dict[str, Any]:
        """Process all temporal windows from start_year to end_year"""
        logger.info(f"🎯 Starting batch processing: {start_year}-{end_year}")
        ...
        for start_win, end_win in windows:
            try:
                ...
                # Add a small delay between windows to avoid overwhelming the system
                time.sleep(2)
