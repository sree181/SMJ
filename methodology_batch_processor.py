#!/usr/bin/env python3
"""
Batch Processor for Methodology Extraction using OLLAMA
Processes all papers from 1985-1994 focusing only on methodology extraction
"""
...
from methodology_extractor import MethodologyProcessor
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('methodology_extraction.log'),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger(__name__)

class MethodologyBatchProcessor:
    """Batch processor for methodology extraction using OLLAMA"""
    ...
    def __init__(self, base_dir: Path, neo4j_uri: str = None, neo4j_user: str = None, 
        ...
        # Initialize the methodology processor
        self.processor = MethodologyProcessor(
    ...
    def process_temporal_window(self, start_year: int, end_year: int, max_workers: int = 2) -> Dict[str, Any]:
        ...
        logger.info(f"🚀 Processing methodology window: {window_name}")
    ...
    def process_all_windows(self, start_year: int, end_year: int, max_workers: int = 2) -> Dict[str, Any]:
        ...
        logger.info(f"🎯 Starting Methodology Extraction: {start_year}-{end_year}")
        ...
        logger.info("🎉 Methodology extraction completed!")
    ...
    def _save_report(self, report: Dict[str, Any]):
        ...
        report_file = f"methodology_extraction_report_{timestamp}.json"
    ...
    def get_knowledge_graph_stats(self) -> Dict[str, Any]:
        ...
        try:
            with self.processor.ingester.driver.session() as session:
                ...
                node_types = ['Paper', 'Methodology', 'QuantitativeMethod', 'QualitativeMethod', 'ResearchDesign']
...
def main():
    """Main function to run methodology extraction"""
    # Configuration
    ...
    processor = MethodologyBatchProcessor(BASE_DIR, ollama_model=OLLAMA_MODEL)
