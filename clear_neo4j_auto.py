#!/usr/bin/env python3
"""
Clear all data from Neo4j Aura instance (non-interactive)
"""
...
def clear_neo4j_auto():
    """Clear all nodes and relationships from Neo4j (non-interactive)"""
    ...
    try:
        ...
        with driver.session() as session:
            ...
            print(f"\n🗑️  Deleting ALL data from Neo4j...")
